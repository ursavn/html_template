...
const listUsedCoupon = [
  {
    date: "group 1 20XX年X月X日",
    coupons: [
      {
        productImage: "./assets/img/img-product.png",
        productName: "item 1-1 外国産バナナ10円引き",
      ...
      {
        productImage: "./assets/img/img-product.png",
        productName: "item 1-2 外国産バナナ10円引き",
        conditionLimit: "1家族1点限り",
        couponStatus: "利用済み",
        mfgDate: "2021年12月1日",
        expDate: "2022年1月◯日",
  ...
  {
    date: "group 2 20XX年X月X日",
    coupons: [
      {
        productImage: "./assets/img/img-product.png",
        productName: "item 2-1 外国産バナナ10円引き",
        conditionLimit: "1家族1点限り",
        couponStatus: "利用済み",
        mfgDate: "2021年12月1日",
        expDate: "2022年1月◯日",
